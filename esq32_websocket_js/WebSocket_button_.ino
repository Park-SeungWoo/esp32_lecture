...
void Main_P()
{
  ...
  html += "#buton {border: 3px solid #191919;border-radius: 40px;background: #2ecc71;width: 80px;height: 80px;position: relative;left: 50%;transform: translatex(-50%);margin-bottom: 50px;}";
  html += "#butoff {border: 3px solid #191919;border-radius: 40px;background: #34495e;width: 80px;height: 80px;position: relative;left: 50%;transform: translatex(-50%);margin-bottom: 50px;}";
  html += "</style>";
  html += "</head>";
  html += "<body>";
  html += "<div class=\"mes\">";
